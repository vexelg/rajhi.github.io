XA.component.search.url = (function ($, document) {
    ...
    var UrlHelperModel = Backbone.Model.extend({
		...
		/* Start: Ovrlode developer create the method 'createMultiFacetUrlWithoutFacetParam' to exclude the facet paramter from URL */
		 createMultiFacetUrlWithoutFacetParam: function (dataProp, facetList, sig) {
            var url = this.setEndpoint(dataProp.endpoint);
